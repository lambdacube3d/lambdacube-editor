...
instance ToJSON MeshAttribute where
  toJSON v = case v of
    A_Float a -> object ["tag" .- "A_Float", "values" .= SV.toList a]
    A_V2F   a -> object ["tag" .- "A_V2F", "values" .= SV.toList a]
    A_V3F   a -> object ["tag" .- "A_V3F", "values" .= SV.toList a]
    A_V4F   a -> object ["tag" .- "A_V4F", "values" .= SV.toList a]
    A_M22F  a -> object ["tag" .- "A_M22F", "values" .= SV.toList a]
    A_M33F  a -> object ["tag" .- "A_M33F", "values" .= SV.toList a]
    A_M44F  a -> object ["tag" .- "A_M44F", "values" .= SV.toList a]
