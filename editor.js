              ...
              if (v1 === "StencilOps") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonStencilOperation)(v)("frontStencilOp"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonStencilOperation)(v)("backStencilOp"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new StencilOps({
                              frontStencilOp: v2, 
                              backStencilOp: v3
                          }));
                      });
              ...
              if (v1 === "Parameter") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("name"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonInputType)(v)("ty"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Parameter({
                              name: v2, 
                              ty: v3
                          }));
                      });
                                  ...
                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("vertexShader"))(function (v6) {
                                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(v)("geometryShader"))(function (v7) {
                                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("fragmentShader"))(function (v8) {
                                              return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Program({
                                                  programUniforms: v2, 
                                                  programStreams: v3, 
              ...
              if (v1 === "TargetItem") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonImageSemantic)(v)("targetSemantic"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(decodeJsonImageRef))(v)("targetRef"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new TargetItem({
                              targetSemantic: v2, 
                              targetRef: v3
                          }));
                      });
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("tag"))(function (v1) {
              if (v1 === "RenderTarget") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonTargetItem))(v)("renderTargets"))(function (v2) {
                      return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new RenderTarget({
                          renderTargets: v2
                      }));
                  });
              };
                          ...
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeStrMap(decodeJsonInputType))(v)("slotUniforms"))(function (v4) {
                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonFetchPrimitive)(v)("slotPrimitive"))(function (v5) {
                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt))(v)("slotPrograms"))(function (v6) {
                                      return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Slot({
                                          slotName: v2, 
                                          slotStreams: v3, 
                                          slotUniforms: v4, 
                                          slotPrimitive: v5, 
                                              ...
                                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonNumber))(v)("samplerMaxLod"))(function (v9) {
                                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonNumber)(v)("samplerLodBias"))(function (v10) {
                                                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(decodeJsonComparisonFunction))(v)("samplerCompareFunc"))(function (v11) {
                                                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new SamplerDescriptor({
                                                              samplerWrapS: v2, 
                                                              samplerWrapT: v3, 
                                                              samplerWrapR: v4, 
                                                              samplerMinFilter: v5, 
                  ...
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonComparisonFunction)(v)("stencilComparision"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("stencilReference"))(function (v3) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("stencilMask"))(function (v4) {
                              return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new StencilTest({
                              ...
                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonSamplerDescriptor)(v)("textureSampler"))(function (v5) {
                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("textureBaseLevel"))(function (v6) {
                                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("textureMaxLevel"))(function (v7) {
                                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new TextureDescriptor({
                                              textureType: v2, 
                                              textureSize: v3, 
                                              textureSemantic: v4, 
                                              textureSampler: v5, 
              ...
              if (v1 === "ClearImage") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonImageSemantic)(v)("imageSemantic"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonValue)(v)("clearValue"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new ClearImage({
                              imageSemantic: v2, 
                              clearValue: v3
                          }));
                      });
                                  ...
                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonBlendingFactor)(v)("alphaFSrc"))(function (v6) {
                                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonBlendingFactor)(v)("alphaFDst"))(function (v7) {
                                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(LinearBase.decodeJsonV4(Data_Argonaut_Decode_Class.decodeJsonNumber))(v)("color"))(function (v8) {
                                              return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Blend({
                                                  colorEqSrc: v2, 
                                                  alphaEqSrc: v3, 
                                                  colorFSrc: v4, 
                                                  colorFDst: v5, 
                      ...
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeStrMap(decodeJsonInputType))(v)("streamType"))(function (v3) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonFetchPrimitive)(v)("streamPrimitive"))(function (v4) {
                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonInt))(v)("streamPrograms"))(function (v5) {
                                  return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new StreamData({
                                      streamData: v2, 
                                      streamType: v3, 
                                      streamPrimitive: v4, 
                                      streamPrograms: v5
              ...
              if (v1 === "AccumulationContext") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonString))(v)("accViewportName"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeList(decodeJsonFragmentOperation))(v)("accOperations"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new AccumulationContext({
                              accViewportName: v2, 
                              accOperations: v3
                          }));
                      });
                                          ...
                                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonSlot))(v)("slots"))(function (v8) {
                                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonStreamData))(v)("streams"))(function (v9) {
                                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonCommand))(v)("commands"))(function (v10) {
                                                      return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Pipeline({
                                                          info: v2, 
                                                          backend: v3, 
                                                          textures: v4, 
                                                          samplers: v5, 
...
(function(exports) {
  ...
  var unlines = function (l) {
      ...
      if ($15 instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at Util line 113, column 14 - line 113, column 78: " + [ $16.constructor.name ]);
      };
      throw new Error("Failed pattern match at Util line 111, column 13 - line 113, column 78: " + [ $15.constructor.name ]);
  };
  var toStreamType = function (a) {
      ...
      return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("invalid Stream Type"));
  };
  var textureDataTypeToGLType = function (v) {
      return function (a) {
          if (v instanceof IR.Color) {
              ...
              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Data_Function.apply(Control_Monad_Eff_Exception.error)("FIXME: This texture format is not yet supported" + Data_Show.show(IR.showTextureDataType)(a)));
          };
          ...
          throw new Error("Failed pattern match at Util line 238, column 1 - line 242, column 104: " + [ v.constructor.name, a.constructor.name ]);
      };
  };
  var textureDataTypeToGLArityType = function (v) {
      return function (a) {
          ...
          throw new Error("Failed pattern match at Util line 251, column 1 - line 255, column 104: " + [ v.constructor.name, a.constructor.name ]);
      };
  };
  var setUniform = function (i) {
      return function (uni) {
          ...
          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (setUniform)!"));
      };
  };
  ...
  var setVertexAttrib = function (i) {
      return function (val) {
          ...
          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (setVertexAttrib)!"));
      };
  };
  var primitiveToGLType = function (p) {
      ...
      throw new Error("Failed pattern match at Util line 176, column 23 - line 183, column 30: " + [ p.constructor.name ]);
  };
  var primitiveToFetchPrimitive = function (prim) {
      ...
      throw new Error("Failed pattern match at Util line 101, column 34 - line 108, column 36: " + [ prim.constructor.name ]);
  };
  var mkUniformSetter = function (v) {
      if (v instanceof IR.Bool) {
          var r = Data_TypedArray.asInt32Array([ 0 ]);
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniBool(r), Data_Function.apply(Type.SBool.create)(function ($126) {
      ...
      if (v instanceof IR.V2B) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV2B(r), Data_Function.apply(Type.SV2B.create)(function ($127) {
      ...
      if (v instanceof IR.V3B) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV3B(r), Data_Function.apply(Type.SV3B.create)(function ($128) {
      ...
      if (v instanceof IR.V4B) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV4B(r), Data_Function.apply(Type.SV4B.create)(function ($129) {
              return $foreign.setIntArray(r)(Type.toIntArray(Type.v4IntStorable(Type.boolIntStorable))($129));
          })));
      };
      if (v instanceof IR.Int) {
          var r = Data_TypedArray.asInt32Array([ 0 ]);
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniInt(r), Data_Function.apply(Type.SInt.create)(function ($130) {
              return $foreign.setIntArray(r)(Type.toIntArray(Type.intIntStorable)($130));
          })));
      };
      if (v instanceof IR.V2I) {
          var r = Data_TypedArray.asInt32Array(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(2)(0));
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV2I(r), Data_Function.apply(Type.SV2I.create)(function ($131) {
              return $foreign.setIntArray(r)(Type.toIntArray(Type.v2IntStorable(Type.intIntStorable))($131));
          })));
      };
      if (v instanceof IR.V3I) {
          var r = Data_TypedArray.asInt32Array(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(3)(0));
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV3I(r), Data_Function.apply(Type.SV3I.create)(function ($132) {
              return $foreign.setIntArray(r)(Type.toIntArray(Type.v3IntStorable(Type.intIntStorable))($132));
          })));
      };
      if (v instanceof IR.V4I) {
          var r = Data_TypedArray.asInt32Array(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(4)(0));
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV4I(r), Data_Function.apply(Type.SV4I.create)(function ($133) {
      ...
      if (v instanceof IR.Float) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniFloat(r), Data_Function.apply(Type.SFloat.create)(function ($134) {
      ...
      if (v instanceof IR.V2F) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV2F(r), Data_Function.apply(Type.SV2F.create)(function ($135) {
      ...
      if (v instanceof IR.V3F) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV3F(r), Data_Function.apply(Type.SV3F.create)(function ($136) {
      ...
      if (v instanceof IR.V4F) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniV4F(r), Data_Function.apply(Type.SV4F.create)(function ($137) {
              return $foreign.setFloatArray(r)(Type.toArray(Type.v4Storable(Type.numStorable))($137));
          })));
      };
      if (v instanceof IR.M22F) {
          var r = Data_TypedArray.asFloat32Array(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(4)(0.0));
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniM22F(r), Data_Function.apply(Type.SM22F.create)(function ($138) {
      ...
      if (v instanceof IR.M33F) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniM33F(r), Data_Function.apply(Type.SM33F.create)(function ($139) {
      ...
      if (v instanceof IR.M44F) {
          ...
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniM44F(r), Data_Function.apply(Type.SM44F.create)(function ($140) {
      ...
      if (v instanceof IR.FTexture2D) {
          return function __do() {
              ...
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Type.UniFTexture2D(v1), Data_Function.apply(Type.SFTexture2D.create)(Control_Monad_Eff_Ref.writeRef(v1))))();
          };
      };
  ...
  var filterToGLType = function (a) {
      ...
      throw new Error("Failed pattern match at Util line 284, column 20 - line 290, column 56: " + [ a.constructor.name ]);
  };
  ...
  var setTextureSamplerParameters = function (t) {
      return function (v) {
          return function __do() {
              Data_Function.apply(Graphics_WebGLRaw.texParameteri_(t)(Graphics_WebGLRaw._TEXTURE_WRAP_S))(edgeModeToGLType(v.value0.samplerWrapS))();
              (function () {
                  if (v.value0.samplerWrapT instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                  };
                  if (v.value0.samplerWrapT instanceof Data_Maybe.Just) {
                      return Data_Function.apply(Graphics_WebGLRaw.texParameteri_(t)(Graphics_WebGLRaw._TEXTURE_WRAP_T))(edgeModeToGLType(v.value0.samplerWrapT.value0));
                  };
                  throw new Error("Failed pattern match at Util line 277, column 5 - line 279, column 79: " + [ v.value0.samplerWrapT.constructor.name ]);
              })()();
              Data_Function.apply(Graphics_WebGLRaw.texParameteri_(t)(Graphics_WebGLRaw._TEXTURE_MIN_FILTER))(filterToGLType(v.value0.samplerMinFilter))();
              return Data_Function.apply(Graphics_WebGLRaw.texParameteri_(t)(Graphics_WebGLRaw._TEXTURE_MAG_FILTER))(filterToGLType(v.value0.samplerMagFilter))();
          };
      };
  };
  var compileTexture = function (v) {
      return function __do() {
          ...
          var txSetup = function (txTarget) {
              return function (dTy) {
                  return function __do() {
                      ...
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v2, v3))();
                  };
              };
          };
          ...
          var div = function (a) {
              return function (b) {
                  return Data_Function.apply($$Math.floor)(a / b);
              };
          };
          var act = (function () {
              if (v.value0.textureType instanceof IR.Texture2D && v.value0.textureType.value1 === 1) {
                  if (v.value0.textureSize instanceof IR.VV2U) {
                      return function __do() {
                          ...
                          Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(Data_Array.zip(levels)(Data_Array.zip(mipS(v.value0.textureSize.value0.value0))(mipS(v.value0.textureSize.value0.value1)))))(function (v3) {
                              return function __do() {
                                  $foreign.texImage2DNull_(Graphics_WebGLRaw._TEXTURE_2D)(v3.value0)(v2.value0)(v3.value1.value0)(v3.value1.value1)(0)(v2.value1)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Util line 227, column 75 - line 227, column 158: " + [ $109.constructor.name ]);
                                  })())();
              ...
              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("Unsupported texture type!"));
          })();
          return act();
      };
  };
  var comparisonFunctionToGLType = function (a) {
      ...
      throw new Error("Failed pattern match at Util line 28, column 32 - line 36, column 32: " + [ a.constructor.name ]);
  };
  var blendingFactorToGLType = function (a) {
      ...
      throw new Error("Failed pattern match at Util line 47, column 28 - line 62, column 40: " + [ a.constructor.name ]);
  };
  var blendEquationToGLType = function (a) {
      ...
      throw new Error("Failed pattern match at Util line 39, column 27 - line 44, column 40: " + [ a.constructor.name ]);
  };
  var arrayTypeToGLType = function (a) {
      ...
      throw new Error("Failed pattern match at Util line 186, column 23 - line 191, column 27: " + [ a.constructor.name ]);
  };
...
(function(exports) {
  ...
  var sortSlotObjects = function (p) {
      return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(p.slotVector))(function (slotRef) {
          return function __do() {
              ...
              var doSort = function (objs) {
                  return Data_Function.apply(Control_Monad_Eff_Ref.writeRef(slotRef))((function () {
                      var $50 = {};
                      for (var $51 in v) {
              ...
              if (v.orderJob instanceof Type.Generate) {
                  var v1 = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_Map.values(v.objectMap)))(function (obj) {
                      return function __do() {
                          var v1 = Control_Monad_Eff_Ref.readRef(obj.order)();
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v1, obj))();
                      };
                  })();
                  return Data_Function.apply(doSort)(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(v1))();
              };
              if (v.orderJob instanceof Type.Reorder) {
                  var v1 = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(v.sortedObjects))(function (v1) {
                      return function __do() {
              ...
              throw new Error("Failed pattern match at Input line 158, column 5 - line 169, column 24: " + [ v.orderJob.constructor.name ]);
          };
      });
  };
  ...
  var mkUniform = function (l) {
      return function __do() {
          var v = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(l))(function (v) {
              return function __do() {
                  var v1 = Util.mkUniformSetter(v.value1)();
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(new Data_Tuple.Tuple(v.value0, v1.value0), new Data_Tuple.Tuple(v.value0, v1.value1)))();
              };
          })();
          var fun = function (v1) {
              return new Data_Tuple.Tuple(Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)(v1.value1)), Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)(v1.value0)));
          };
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(fun)(Data_Array.unzip(v)))();
      };
  };
  var mkWebGLPipelineInput = function (sch) {
      return Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
          var len = Data_Function.apply(Data_Maybe.fromJust(dictPartial))(Data_Function.apply(Data_Int.fromNumber)(Data_StrMap.size(sch.slots)));
          var sm = Data_Function.apply(Data_StrMap.fromList)(Data_List.zip(Data_Function.apply(Data_List.fromFoldable(Data_Foldable.foldableArray))(Data_StrMap.keys(sch.slots)))(Data_List.range(0)(len)));
          return function __do() {
              var v = Data_Function.apply(mkUniform)(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.toList(sch.uniforms)))();
              var v1 = Data_Function.apply(Data_Unfoldable.replicateA(Control_Monad_Eff.applicativeEff)(Data_Unfoldable.unfoldableArray)(Data_Traversable.traversableArray)(len))(Control_Monad_Eff_Ref.newRef({
          ...
          return function (obj) {
              return function (prg) {
                  var objUniCmds = (function () {
                      var uniMap = Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.toList(prg.inputUniforms));
                      var uniCmds = Data_Function.apply(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(uniMap))(function (v) {
                          return Data_Function.apply(Type.GLSetUniform.create(v.value1))((function () {
                              ...
                              throw new Error("Failed pattern match at Input line 279, column 53 - line 281, column 23: " + [ $138.constructor.name ]);
                          })());
                      });
                      var topUni = function (n) {
                          return Data_StrMap_Unsafe.unsafeIndex(topUnis)(n);
                      };
                      var texCmds = Data_Function.apply(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(prg.inputTextureUniforms))(function (n) {
                          var u = (function () {
                              ...
                              throw new Error("Failed pattern match at Input line 283, column 19 - line 285, column 32: " + [ $142.constructor.name ]);
                          })();
                  ...
                  var objStreamCmds = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                      return Data_Function.apply(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.values(prg.inputStreams))))(function (is) {
                          var s = Data_StrMap_Unsafe.unsafeIndex(obj.attributes)(is.slotAttribute);
                          if (s instanceof Type.Stream) {
                              var desc = Data_Array_Partial.unsafeIndex(dictPartial)(s.value0.buffer.arrays)(s.value0.arrIdx);
                              var glType = Util.arrayTypeToGLType(desc.arrType);
                              var ptr = function (compCnt) {
                                  return desc.arrOffset + ((s.value0.start * compCnt | 0) * Type.sizeOfArrayType(desc.arrType) | 0) | 0;
                              };
                              var setFloatAttrib = function (n) {
                                  return new Type.GLSetVertexAttribArray(is.location, s.value0.buffer.glBuffer, n, glType, ptr(n));
                              };
                              return Data_Function.apply(setFloatAttrib)((function () {
                                  ...
                                  throw new Error("Failed pattern match at Input line 300, column 16 - line 308, column 13: " + [ s.value0.sType.constructor.name ]);
                              })());
                          };
                          return new Type.GLSetVertexAttrib(is.location, s);
                      });
                  });
                  var objDrawCmd = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                      ...
                      var count = Data_Array_Partial.unsafeIndex(dictPartial)(Data_Function.apply(Data_Array.concatMap(streamLen))(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.values(obj.attributes))))(0);
                      ...
                      if (obj.indices instanceof Data_Maybe.Just) {
                          var a = Data_Array_Partial.unsafeIndex(dictPartial)(obj.indices.value0.buffer.arrays)(obj.indices.value0.arrIdx);
                          var idxType = Util.arrayTypeToGLType(a.arrType);
                          var ptr = a.arrOffset + (obj.indices.value0.start * Type.sizeOfArrayType(a.arrType) | 0) | 0;
                          return new Type.GLDrawElements(prim, obj.indices.value0.length, idxType, obj.indices.value0.buffer.glBuffer, ptr);
                      };
                      throw new Error("Failed pattern match at Input line 265, column 10 - line 271, column 74: " + [ obj.indices.constructor.name ]);
                  });
              ...
              return function (indices) {
                  return function (attribs) {
                      return function (uniformNames) {
                          return Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                              return function __do() {
                                  Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(uniformNames))(function (n) {
                                      var $151 = Data_StrMap.lookup(n)(input.schema.uniforms);
                                      if ($151 instanceof Data_Maybe.Nothing) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Data_Function.apply(Control_Monad_Eff_Exception.error)("Unknown uniform: " + Data_Show.show(Data_Show.showString)(n)));
                                      };
                                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                  })();
                                  (function () {
                                      ...
                                      if ($152 instanceof Data_Maybe.Nothing) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Data_Function.apply(Control_Monad_Eff_Exception.error)("Unknown slot: " + slotName));
                                      };
                                      if ($152 instanceof Data_Maybe.Just) {
                                          return function __do() {
                                              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Eq.notEq(IR.eqFetchPrimitive)($152.value0.primitive)(Util.primitiveToFetchPrimitive(prim))))(Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Data_Function.apply(Control_Monad_Eff_Exception.error)("Primitive mismatch for slot (" + (Data_Show.show(Data_Show.showString)(slotName) + (") expected " + (Data_Show.show(IR.showFetchPrimitive)($152.value0.primitive) + (" but got " + Data_Show.show(Type.showPrimitive)(prim))))))))();
                                              var sType = Data_Functor.map(Data_StrMap.functorStrMap)(Type.streamToStreamType)(attribs);
                                              return Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Eq.notEq(Data_StrMap.eqStrMap(Type.eqStreamType))(sType)($152.value0.attributes)))(Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Data_Function.apply(Control_Monad_Eff_Exception.error)(Data_Function.apply(Util.unlines)([ "Attribute stream mismatch for slot (" + (Data_Show.show(Data_Show.showString)(slotName) + ") expected "), Data_Show.show(Data_StrMap.showStrMap(Type.showStreamType))($152.value0.attributes), " but got ", Data_Show.show(Data_StrMap.showStrMap(Type.showStreamType))(sType) ]))))();
                                          };
                                      };
                                      throw new Error("Failed pattern match at Input line 75, column 5 - line 86, column 18: " + [ $152.constructor.name ]);
                                  })()();
                                  var v = (function () {
                                      var $154 = Data_StrMap.lookup(slotName)(input.slotMap);
                                      if ($154 instanceof Data_Maybe.Nothing) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (slot index)"));
                                      };
                                      if ($154 instanceof Data_Maybe.Just) {
                                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($154.value0);
                                      };
                                      throw new Error("Failed pattern match at Input line 88, column 16 - line 90, column 24: " + [ $154.constructor.name ]);
                                  })()();
                                  ...
                                  var v4 = Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(mkUniform)(Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(uniformNames))(function (n) {
                                      var $160 = Data_StrMap.lookup(n)(input.schema.uniforms);
                                      if ($160 instanceof Data_Maybe.Nothing) {
                                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (uniform setter not found)"));
                                      };
                                      if ($160 instanceof Data_Maybe.Just) {
                                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(n, $160.value0));
                                      };
                                      throw new Error("Failed pattern match at Input line 95, column 67 - line 97, column 33: " + [ $160.constructor.name ]);
                                  }))();
                                  ...
                                  Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(Data_Array_Partial.unsafeIndex(dictPartial)(input.slotVector)(v)))(function (s) {
                                      return {
                                  ...
                                  var v7 = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(v6))(function (mp) {
                                          ...
                                          return function __do() {
                                              ...
                                              return __unused(dictPartial)((function () {
                                                  if (v7 instanceof Data_Maybe.Just) {
                                                      var $167 = Data_Array_Partial.unsafeIndex(dictPartial)(v7.value0.value0.slotMapInputToPipeline)(v);
                                                      if ($167 instanceof Data_Maybe.Nothing) {
                                                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)([  ]);
                                                      };
                                                      if ($167 instanceof Data_Maybe.Just) {
                                                          ...
                                                          var addCmds = function (v8) {
                                                              return function (prgIdx) {
                                                                  return Data_Function.apply(Data_Maybe.fromJust(dictPartial))(Data_Array.updateAt(prgIdx)(createObjectCommands(mp.value0.texUnitMapping)(input.uniformSetup)(obj)(Data_Array_Partial.unsafeIndex(dictPartial)(mp.value0.programs)(prgIdx)))(v8));
                                                              };
                                                          };
                                                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Data_Foldable.foldl(Data_Foldable.foldableArray)(addCmds)(emptyV))(Data_Array_Partial.unsafeIndex(dictPartial)(mp.value0.slotPrograms)($167.value0)));
                                                      };
                                                      throw new Error("Failed pattern match at Input line 125, column 13 - line 131, column 88: " + [ $167.constructor.name ]);
                                                  };
                                                  throw new Error("Failed pattern match at Input line 123, column 20 - line 131, column 88: " + [ v7.constructor.name ]);
                                              })())();
                                          };
                                      };
                                      throw new Error("Failed pattern match at Input line 121, column 31 - line 131, column 88: " + [ mp.constructor.name ]);
                                  })();
...
(function(exports) {
          ...
          return function __do() {
              ...
              return Util.loadImage_(name, function (image) {
                  return function __do() {
                      ...
                      return Data_Function.apply(action)(new Type.TextureData(v))();
                  };
              })();
          };
      };
  ...
  var compileBuffer = function (arrs) {
      ...
      var size = (function () {
          ...
          throw new Error("Failed pattern match at Data line 27, column 16 - line 30, column 5: " + [ $19.constructor.name ]);
      })();
      return function __do() {
          var v = Util.newArrayBuffer(size)();
          var v1 = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(Data_Function.apply(Data_Array.zip(arrs))(Data_Array.take(Data_Array.length(arrs))(offsets))))(function (v1) {
              var newView = (function () {
                  ...
                  throw new Error("Failed pattern match at Data line 34, column 21 - line 39, column 38: " + [ v1.value0.value0.constructor.name ]);
              })();
...
(function(exports) {
  ...
  var setupRasterContext = (function () {
      var setPointSize = function (ps) {
          ...
          throw new Error("Failed pattern match at Backend line 54, column 23 - line 58, column 5: " + [ ps.constructor.name ]);
      };
      var cff = function (v) {
          ...
          throw new Error("Failed pattern match at Backend line 42, column 5 - line 42, column 22: " + [ v.constructor.name ]);
      };
      var cvt = function (v) {
          ...
          if (v instanceof IR.TriangleCtx) {
              return function __do() {
                  (function () {
                      ...
                      if (v.value0 instanceof IR.CullFront) {
                          return function __do() {
                              ...
                              return Data_Function.apply(Graphics_WebGLRaw.frontFace_)(cff(v.value0.value0))();
                          };
                      };
                      ...
                      throw new Error("Failed pattern match at Backend line 74, column 9 - line 83, column 38: " + [ v.value0.constructor.name ]);
                  })()();
                  ...
                  throw new Error("Failed pattern match at Backend line 101, column 9 - line 105, column 51: " + [ v.value2.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Backend line 59, column 5 - line 60, column 24: " + [ v.constructor.name ]);
      };
      return cvt;
  })();
  var setupAccumulationContext = function (v) {
      var cvtC = function (v1) {
          return function (v2) {
              if (v2 instanceof Data_List.Cons && v2.value0 instanceof IR.ColorOp) {
                  return function __do() {
                      (function () {
                          ...
                          throw new Error("Failed pattern match at Backend line 139, column 9 - line 159, column 127: " + [ v2.value0.value0.constructor.name ]);
                      })()();
                      (function () {
              ...
              throw new Error("Failed pattern match at Backend line 137, column 5 - line 166, column 24: " + [ v1.constructor.name, v2.constructor.name ]);
          };
      };
      var cvt = function (v1) {
          ...
          if (v1 instanceof Data_List.Cons && v1.value0 instanceof IR.DepthOp) {
              return function __do() {
                  ...
                  (function () {
                      ...
                      throw new Error("Failed pattern match at Backend line 124, column 9 - line 129, column 33: " + [ $160.constructor.name ]);
                  })()();
                  return cvtC(0)(v1.value1)();
              };
          };
  ...
  var renderSlot = function (cmds) {
      return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(cmds))(function (cmd) {
          ...
          if (cmd instanceof Type.GLBindTexture && cmd.value2 instanceof Type.UniFTexture2D) {
              return function __do() {
                  ...
                  Data_Function.apply(Graphics_WebGLRaw.activeTexture_)(Graphics_WebGLRaw._TEXTURE0 + v1 | 0)();
              ...
              return function (primitive) {
                  return function (prg) {
                      var streamUniCmds = (function () {
                          var uniMap = Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.toList(prg.inputUniforms));
                          var uniCmds = Data_Function.apply(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(uniMap))(function (v) {
                              return Data_Function.apply(Type.GLSetUniform.create(v.value1))(Data_StrMap_Unsafe.unsafeIndex(topUnis)(v.value0));
                          });
                          var topUni = function (n) {
                              return Data_StrMap_Unsafe.unsafeIndex(topUnis)(n);
                          };
                      ...
                      var streamCmds = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                          return Data_Function.apply(Data_Function.flip(Data_Functor.map(Data_Functor.functorArray))(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.values(prg.inputStreams))))(function (is) {
                              ...
                              if (s instanceof Type.Stream) {
                                  ...
                                  return Data_Function.apply(setFloatAttrib)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Backend line 383, column 16 - line 391, column 13: " + [ s.value0.sType.constructor.name ]);
                                  })());
                              };
                              return new Type.GLSetVertexAttrib(is.location, s);
                          });
                      ...
                      var drawCmd = (function () {
                          ...
                          var count = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                              return Data_Array_Partial.unsafeIndex(dictPartial)(Data_Function.apply(Data_Array.concatMap(streamLen))(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.values(attrs))))(0);
                          });
                          return new Type.GLDrawArrays(prim, 0, count);
                      })();
              ...
              return function __do() {
                  ...
                  (function () {
                      ...
                      if (v instanceof Data_Maybe_1.Just) {
                          return function __do() {
                              Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(v.value0.value0.input.pipelines))(function (v1) {
                                  return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(v.value0.value0.id)(Data_Maybe_1.Nothing.value)(v1));
                              })();
                              return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v.value0.value0.slotMapPipelineToInput))(function (slotIdx) {
                                  return function __do() {
                                      var v1 = Control_Monad_Eff_Ref.readRef(Data_Array_Partial.unsafeIndex(dictPartial)(v.value0.value0.input.slotVector)(slotIdx))();
                                      return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_Map.values(v1.objectMap)))(function (obj) {
                                          return Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(obj.commands))(function (v2) {
                                              return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(v.value0.value0.id)([  ])(v2));
                                          });
                                      })();
                                  };
                              })();
                      ...
                      throw new Error("Failed pattern match at Backend line 532, column 5 - line 539, column 82: " + [ v.constructor.name ]);
                  })()();
                  if (input$prime instanceof Data_Maybe_1.Nothing) {
                      return Control_Monad_Eff_Ref.writeRef(p.input)(Data_Maybe_1.Nothing.value)();
                  };
                  if (input$prime instanceof Data_Maybe_1.Just) {
                      var v1 = Control_Monad_Eff_Ref.readRef(input$prime.value0.pipelines)();
                      var v2 = (function () {
                          var $208 = Data_Array.findIndex(Data_Maybe_1.isNothing)(v1);
                          if ($208 instanceof Data_Maybe_1.Nothing) {
                              var len = Data_Array.length(v1);
                              return function __do() {
                                  Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(input$prime.value0.pipelines))(function (v2) {
                                      return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(len)(new Data_Maybe_1.Just(p))(Data_Array.concat([ v2, Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(len)(Data_Maybe_1.Nothing.value) ])));
                                  })();
                                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(len, new Data_Maybe_1.Just(len)))();
                              };
                          };
                          if ($208 instanceof Data_Maybe_1.Just) {
                              return function __do() {
                                  Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(input$prime.value0.pipelines))(function (v2) {
                                      return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt($208.value0)(new Data_Maybe_1.Just(p))(v2));
                                  })();
                                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple($208.value0, Data_Maybe_1.Nothing.value))();
                              };
                          };
                          throw new Error("Failed pattern match at Backend line 551, column 39 - line 559, column 43: " + [ $208.constructor.name ]);
                      })()();
                      var v3 = Data_Function.apply(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_Traversable.traversableArray)(p.slotNames))(function (n) {
                          var $211 = Data_StrMap.lookup(n)(input$prime.value0.slotMap);
                          if ($211 instanceof Data_Maybe_1.Nothing) {
                              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error: unknown slot name in input"));
                          };
                          if ($211 instanceof Data_Maybe_1.Just) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($211.value0);
                          };
                          throw new Error("Failed pattern match at Backend line 561, column 45 - line 563, column 31: " + [ $211.constructor.name ]);
                      })();
                      var iToP = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v4) {
                          return function (p1) {
                              return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(v4.value1)(new Data_Maybe_1.Just(v4.value0))(p1));
                          };
                      })(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Function.apply(Data_Int.fromNumber)(Data_StrMap.size(input$prime.value0.slotMap))))(Data_Maybe_1.Nothing.value))(Data_Array.zip(Data_Array.range(0)(Data_Array.length(v3)))(v3));
                      Data_Function.apply(Control_Monad_Eff_Ref.writeRef(p.input))(Data_Function.apply(Data_Maybe_1.Just.create)(new Type.InputConnection({
                          id: v2.value0, 
                      ...
                      var extend = function (v4) {
                          if (v2.value1 instanceof Data_Maybe_1.Nothing) {
                              return v4;
                          };
                          if (v2.value1 instanceof Data_Maybe_1.Just) {
                              return Data_Array.concat([ v4, Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(v2.value1.value0)([  ]) ]);
                          };
                          throw new Error("Failed pattern match at Backend line 577, column 28 - line 579, column 57: " + [ v2.value1.constructor.name ]);
                      };
                      var emptyV = Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(Data_Array.length(p.programs))([  ]);
                      Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(Data_Array.zip(v3)(p.slotPrograms)))(function (v4) {
                          return function __do() {
                              var v5 = Data_Function.apply(Control_Monad_Eff_Ref.readRef)(Data_Array_Partial.unsafeIndex(dictPartial)(input$prime.value0.slotVector)(v4.value0))();
                              return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_Map.values(v5.objectMap)))(function (obj) {
                                  var updateCmds = function (v6) {
                                      return function (prgIdx) {
                                          return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(prgIdx)(Input.createObjectCommands(p.texUnitMapping)(input$prime.value0.uniformSetup)(obj)(Data_Array_Partial.unsafeIndex(dictPartial)(p.programs)(prgIdx)))(v6));
                                      };
                                  };
                                  var cmdV = Data_Foldable.foldl(Data_Foldable.foldableArray)(updateCmds)(emptyV)(v4.value1);
                                  return Data_Function.apply(Control_Monad_Eff_Ref.modifyRef(obj.commands))(function (v6) {
                                      return Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Array.updateAt(v2.value0)(cmdV)(extend(v6)));
                                  });
                              })();
                          };
                      })();
                      return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(p.streams))(function (s) {
                          return Data_Function.apply(Control_Monad_Eff_Ref.writeRef(s.commands))(createStreamCommands(p.texUnitMapping)(input$prime.value0.uniformSetup)(s.attributes)(s.primitive)(Data_Array_Partial.unsafeIndex(dictPartial)(p.programs)(s.program)));
                      })();
                  };
                  throw new Error("Failed pattern match at Backend line 547, column 5 - line 589, column 143: " + [ input$prime.constructor.name ]);
              };
          });
      };
  };
  var disposePipeline = function (p) {
      return function __do() {
          setPipelineInput(p)(Data_Maybe_1.Nothing.value)();
          return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(p.programs))(function (prg) {
              return function __do() {
          ...
          var compileAttr = function (v1) {
              ...
              return __unused(dictPartial)((function () {
                  ...
                  if (v1 instanceof IR.VIntArray) {
                      return Data_Function.apply((Type["Array"]).create(Type.ArrInt16.value))(Type.toArray(Type.arrStorable(Type.intStorable))(v1.value0));
                  };
                  if (v1 instanceof IR.VWordArray) {
                      return Data_Function.apply((Type["Array"]).create(Type.ArrWord16.value))(Type.toArray(Type.arrStorable(Type.intStorable))(v1.value0));
                  };
                  throw new Error("Failed pattern match at Backend line 302, column 7 - line 302, column 53: " + [ v1.constructor.name ]);
              })());
          };
          return function __do() {
              var v1 = Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Data_Array.unzip)(Data_Function.apply(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                  return new Data_Tuple.Tuple(new Data_Tuple.Tuple(v1.value1.value0, v1.value0), compileAttr(v1.value1.value1));
              }))(Data_Function.apply(Data_Array.zip(Data_Array.range(0)(Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Function.apply(Data_Int.fromNumber)(Data_StrMap.size(v.value0.streamData) - 1.0)))))(Data_Function.apply(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray))(Data_StrMap.toList(v.value0.streamData))))))();
              var getLength = function (n) {
                  return function __do() {
                      var v2 = (function () {
                          var $237 = Data_StrMap.lookup(n)(v.value0.streamData);
                          if ($237 instanceof Data_Maybe_1.Just && $237.value0 instanceof IR.VFloatArray) {
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Array.length($237.value0.value0));
                          };
                          if ($237 instanceof Data_Maybe_1.Just && $237.value0 instanceof IR.VIntArray) {
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Array.length($237.value0.value0));
                          };
                          if ($237 instanceof Data_Maybe_1.Just && $237.value0 instanceof IR.VWordArray) {
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Array.length($237.value0.value0));
                          };
                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("compileStreamData - getLength"));
                      })()();
                      var v3 = (function () {
                          var $245 = Data_StrMap.lookup(n)(v.value0.streamType);
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.Float) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(1);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.V2F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(2);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.V3F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(3);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.V4F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(4);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.M22F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(4);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.M33F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(9);
                          };
                          if ($245 instanceof Data_Maybe_1.Just && $245.value0 instanceof IR.M44F) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(16);
                          };
                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("compileStreamData - getLength element count"));
                      })()();
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(v2 / v3 | 0)();
                  };
              };
              ...
              var toStream = function (v4) {
                  return function __do() {
                      var v5 = Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(Util.toStreamType)((function () {
                          ...
                          if ($257 instanceof Data_Maybe_1.Just) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($257.value0);
                          };
                          if ($257 instanceof Data_Maybe_1.Nothing) {
                              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("compileStreamData - toStream"));
                          };
                          throw new Error("Failed pattern match at Backend line 326, column 14 - line 329, column 9: " + [ $257.constructor.name ]);
                      })())();
                      var v6 = getLength(v4.value0)();
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v4.value0, new Type.Stream({
                          sType: v5, 
                          buffer: v2, 
                          arrIdx: v4.value1, 
                          start: 0, 
              ...
              return {
                  ...
                  primitive: (function () {
                      ...
                      return __unused(dictPartial)((function () {
                          ...
                          throw new Error("Failed pattern match at Backend line 340, column 18 - line 343, column 34: " + [ v.value0.streamPrimitive.constructor.name ]);
                      })());
                  })(), 
                  attributes: Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)(v4)), 
                  program: Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Function.apply(Data_Array.head)(v.value0.streamPrograms))
              };
          };
      });
  };
      ...
      return function (glTexs) {
          return function (v) {
              return Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
                  ...
                  var images = Data_Function.apply(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                      return Data_Maybe_1.fromJust(dictPartial)(v1.value0.targetRef);
                  }))(Data_Array.filter(function (v1) {
                      return Data_Maybe_1.isJust(v1.value0.targetRef);
                  })(v.value0.renderTargets));
                  var act1 = (function () {
                      var $277 = Data_Foldable.all(Data_Foldable.foldableArray)(Data_BooleanAlgebra.booleanAlgebraBoolean)(isFB)(images);
                      if ($277) {
                          ...
                          var cvt = function (v1) {
                              if (v1.value0.targetRef instanceof Data_Maybe_1.Nothing) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Graphics_WebGLRaw._NONE);
                              };
                              if (v1.value0.targetRef instanceof Data_Maybe_1.Just && (v1.value0.targetRef.value0 instanceof IR.Framebuffer && v1.value0.targetRef.value0.value0 instanceof IR.Color)) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Graphics_WebGLRaw._BACK);
                              };
                              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (compileRenderTarget)!"));
                          };
                          return function __do() {
                              var v1 = Data_Function.apply(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(cvt))(Data_Array.filter(function (v1) {
                                  return isColor(v1.value0.targetSemantic);
                              })(v.value0.renderTargets))();
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))({
                                  framebufferObject: $foreign.nullWebGLFramebuffer, 
                                  framebufferDrawbuffers: new Data_Maybe_1.Just(v1)
                              })();
                          };
                      };
                      if (!$277) {
                          return function __do() {
                              Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(Data_Foldable.any(Data_Foldable.foldableArray)(Data_BooleanAlgebra.booleanAlgebraBoolean)(isFB)(images)))(Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (compileRenderTarget)!")))();
                              ...
                              var attach = function (v2) {
                                  return function (v3) {
                                      if (v3 instanceof IR.TextureImage && v3.value2 instanceof Data_Maybe_1.Nothing) {
                                          var tex = Data_Array_Partial.unsafeIndex(dictPartial)(texs)(v3.value0);
                                          var glTex = Data_Array_Partial.unsafeIndex(dictPartial)(glTexs)(v3.value0);
                                          var attach2D = Graphics_WebGLRaw.framebufferTexture2D_(Graphics_WebGLRaw._FRAMEBUFFER)(v2)(glTex.textureTarget)(glTex.textureObject)(v3.value1);
                                          var act0 = (function () {
                                              if (tex.value0.textureType instanceof IR.Texture2D && tex.value0.textureType.value1 === 1) {
                                                  return attach2D;
                                              };
                                              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("invalid texture format!"));
                                          })();
                                          return act0;
                                      };
                                      return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("invalid texture format!"));
                              ...
                              var go = function (v2) {
                                  return function (v3) {
                                      if (v3.value0.targetSemantic instanceof IR.Stencil && v3.value0.targetRef instanceof Data_Maybe_1.Just) {
                                          return function __do() {
                                              Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("Stencil support is not implemented yet!"))();
                                              return v2;
                                          };
                                      };
                                      if (v3.value0.targetSemantic instanceof IR.Depth && v3.value0.targetRef instanceof Data_Maybe_1.Just) {
                                          return function __do() {
                                              attach(Graphics_WebGLRaw._DEPTH_ATTACHMENT)(v3.value0.targetRef.value0)();
                                              return v2;
                                          };
                                      };
                                      if (v3.value0.targetSemantic instanceof IR.Color && v3.value0.targetRef instanceof Data_Maybe_1.Just) {
                                          return function __do() {
                                      ...
                                      if (v3.value0.targetSemantic instanceof IR.Color && v3.value0.targetRef instanceof Data_Maybe_1.Nothing) {
                              ...
                              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))({
                                  ...
                                  framebufferDrawbuffers: Data_Maybe_1.Nothing.value
                              })();
                          };
                      };
                      throw new Error("Failed pattern match at Backend line 251, column 14 - line 297, column 20: " + [ $277.constructor.name ]);
                  })();
                  return act1;
              });
          };
  ...
  var compileProgram = function (v) {
      return function __do() {
          ...
          var createAndAttach = function (src) {
              return function (t) {
                  return function __do() {
                      ...
                      Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v4 !== true))(Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("compileShader failed!")))();
          ...
          Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v5 !== true))(Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("link program failed!")))();
          var v6 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_StrMap.fromList)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_StrMap.toList(v.value0.programUniforms))(function (v6) {
              return function __do() {
                  var v7 = Graphics_WebGLRaw.getUniformLocation_(v1)(v6.value0)();
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v6.value0, v7))();
              };
          }))();
          var v7 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_StrMap.fromList)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_StrMap.toList(v.value0.programInTextures))(function (v7) {
              return function __do() {
                  var v8 = Graphics_WebGLRaw.getUniformLocation_(v1)(v7.value0)();
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v7.value0, v8))();
              };
          }))();
          var v8 = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_StrMap.fromList)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_StrMap.toList(v.value0.programStreams))(function (v8) {
              return function __do() {
                  var v9 = Graphics_WebGLRaw.getAttribLocation_(v1)(v8.value0)();
                  Data_Function.apply(Control_Monad_Eff_Console.log)("attrib location " + (v8.value0 + (" " + Data_Show.show(Data_Show.showInt)(v9))))();
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(v8.value0, {
                      location: v9, 
                      slotAttribute: v8.value1.value0.name
                  }))();
              };
          }))();
          var texUnis = Data_Function.apply(Data_Array.filter(function (n) {
          ...
          return function (v1) {
              if (v1.value0.imageSemantic instanceof IR.Depth && v1.value0.clearValue instanceof IR.VFloat) {
                  return function __do() {
                      ...
                      return {
                          mask: Data_Int_Bits.or(v.mask)(Graphics_WebGLRaw._DEPTH_BUFFER_BIT), 
                          index: v.index
                      };
                  };
              };
              if (v1.value0.imageSemantic instanceof IR.Stencil && v1.value0.clearValue instanceof IR.VWord) {
                  return function __do() {
                      ...
                      return {
                          mask: Data_Int_Bits.or(v.mask)(Graphics_WebGLRaw._STENCIL_BUFFER_BIT), 
                          index: v.index
                      };
                  };
              };
              if (v1.value0.imageSemantic instanceof IR.Color) {
                  return function __do() {
                      ...
                      return {
                          mask: Data_Int_Bits.or(v.mask)(Graphics_WebGLRaw._COLOR_BUFFER_BIT), 
                          index: v.index + 1 | 0
                      };
                  };
              };
              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (clearRenderTarget)"));
          };
      };
      return function __do() {
  ...
  var renderPipeline = function (p) {
      return Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
          return function __do() {
              Control_Monad_Eff_Ref.writeRef(p.curProgram)(Data_Maybe_1.Nothing.value)();
              return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(p.commands))(function (cmd) {
                  if (cmd instanceof IR.SetRenderTarget) {
                      var rt = Data_Array_Partial.unsafeIndex(dictPartial)(p.targets)(cmd.value0);
                      return function __do() {
                          var v = Control_Monad_Eff_Ref.readRef(p.input)();
                          (function () {
                              if (v instanceof Data_Maybe_1.Nothing) {
                              ...
                              throw new Error("Failed pattern match at Backend line 425, column 9 - line 429, column 45: " + [ v.constructor.name ]);
                          })()();
                          return Graphics_WebGLRaw.bindFramebuffer_(Graphics_WebGLRaw._FRAMEBUFFER)(rt.framebufferObject)();
                      };
                  };
                  if (cmd instanceof IR.SetSamplerUniform) {
                      return function __do() {
                          var cp = Control_Monad_Eff_Ref.readRef(p.curProgram)();
                          if (cp instanceof Data_Maybe_1.Nothing) {
                              return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("invalid pipeline, no active program"))();
                          };
                          if (cp instanceof Data_Maybe_1.Just) {
                              var $388 = Data_StrMap.lookup(cmd.value0)((Data_Array_Partial.unsafeIndex(dictPartial)(p.programs)(cp.value0)).inputSamplers);
                              if ($388 instanceof Data_Maybe_1.Nothing) {
                                  return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (SetSamplerUniform)!"))();
                              };
                              if ($388 instanceof Data_Maybe_1.Just) {
                                  var $389 = Data_StrMap.lookup(cmd.value0)(p.texUnitMapping);
                                  if ($389 instanceof Data_Maybe_1.Nothing) {
                                      return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("internal error (SetSamplerUniform)!"))();
                                  };
                                  if ($389 instanceof Data_Maybe_1.Just) {
                                      Control_Monad_Eff_Ref.writeRef($389.value0)(cmd.value1)();
                                      return Graphics_WebGLRaw.uniform1i_($388.value0)(cmd.value1)();
                                  };
                                  throw new Error("Failed pattern match at Backend line 444, column 24 - line 448, column 35: " + [ $389.constructor.name ]);
                              };
                              throw new Error("Failed pattern match at Backend line 442, column 27 - line 448, column 35: " + [ $388.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Backend line 440, column 41 - line 448, column 35: " + [ cp.constructor.name ]);
                      };
                  };
                  if (cmd instanceof IR.SetTexture) {
                      return function __do() {
                          Graphics_WebGLRaw.activeTexture_(Graphics_WebGLRaw._TEXTURE0 + cmd.value0 | 0)();
                          var tx = Data_Array_Partial.unsafeIndex(dictPartial)(p.textures)(cmd.value1);
                          return Graphics_WebGLRaw.bindTexture_(tx.textureTarget)(tx.textureObject)();
                      };
                  };
                  ...
                  if (cmd instanceof IR.SetProgram) {
                      return function __do() {
                          Control_Monad_Eff_Ref.writeRef(p.curProgram)(new Data_Maybe_1.Just(cmd.value0))();
                          return Data_Function.apply(Graphics_WebGLRaw.useProgram_)((Data_Array_Partial.unsafeIndex(dictPartial)(p.programs)(cmd.value0)).program)();
                      };
                  };
                  if (cmd instanceof IR.RenderStream) {
                      return Control_Bind.bindFlipped(Control_Monad_Eff.bindEff)(renderSlot)(Control_Monad_Eff_Ref.readRef((Data_Array_Partial.unsafeIndex(dictPartial)(p.streams)(cmd.value0)).commands));
                  };
                  if (cmd instanceof IR.RenderSlot) {
                      return function __do() {
                          ...
                          if (cp instanceof Data_Maybe_1.Just) {
                              ...
                              if (input instanceof Data_Maybe_1.Nothing) {
                                  return Data_Unit.unit;
                              };
                              if (input instanceof Data_Maybe_1.Just) {
                                  var v = Control_Monad_Eff_Ref.readRef(Data_Array_Partial.unsafeIndex(dictPartial)(input.value0.value0.input.slotVector)(Data_Array_Partial.unsafeIndex(dictPartial)(input.value0.value0.slotMapPipelineToInput)(cmd.value0)))();
                                  return Data_Function.apply(Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_Foldable.foldableArray)(v.sortedObjects))(function (v1) {
                                      return function __do() {
                                          var v2 = Control_Monad_Eff_Ref.readRef(v1.value1.enabled)();
                                          return Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v2))(function __do() {
                                              var v3 = Control_Monad_Eff_Ref.readRef(v1.value1.commands)();
                                              return Data_Function.apply(renderSlot)(Data_Array_Partial.unsafeIndex(dictPartial)(Data_Array_Partial.unsafeIndex(dictPartial)(v3)(input.value0.value0.id))(cp.value0))();
                                          })();
                                      };
                                  })();
                              };
                              throw new Error("Failed pattern match at Backend line 473, column 57 - line 482, column 81: " + [ input.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Backend line 471, column 41 - line 482, column 81: " + [ cp.constructor.name ]);
                      };
                  };
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
              })();
  ...
  var allocPipeline = function (v) {
      return function __do() {
          ...
          })(Data_Function.apply(Data_Array.nub(Data_Eq.eqString))(Data_Array.concatMap(function (v4) {
              return Data_StrMap.keys(v4.value0.programInTextures);
          })(v.value0.programs))))();
          var v5 = Control_Monad_Eff_Ref.newRef(Data_Maybe_1.Nothing.value)();
          var v6 = Control_Monad_Eff_Ref.newRef(Data_Maybe_1.Nothing.value)();
...
(function(exports) {
  ...
  var decodeJsonRange = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("tag"))(function (v1) {
                      ...
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("startColumn"))(function (v3) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("endLine"))(function (v4) {
                              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("endColumn"))(function (v5) {
                                  return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Range({
                                      startLine: v2, 
                                      startColumn: v3, 
                                      endLine: v4, 
                                      endColumn: v5
              ...
              return Partial_Unsafe.unsafeCrashWith("decodeJson @ Range");
          });
      });
  });
  var decodeJsonTypeInfo = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("tag"))(function (v1) {
              if (v1 === "TypeInfo") {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonRange)(v)("range"))(function (v2) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("text"))(function (v3) {
                          return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new TypeInfo({
                              range: v2, 
                              text: v3
                          }));
                      });
              ...
              return Partial_Unsafe.unsafeCrashWith("decodeJson @ TypeInfo");
          });
      });
  });
  var decodeJsonCompileResult = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("tag"))(function (v1) {
              if (v1 === "CompileError") {
                  return Control_Apply.apply(Data_Either.applyEither)(Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(CompileError.create)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonRange))(v)("arg0")))(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("arg1")))(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonTypeInfo))(v)("arg2"));
              };
              if (v1 === "Compiled") {
                  return Control_Apply.apply(Data_Either.applyEither)(Control_Apply.apply(Data_Either.applyEither)(Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(Compiled.create)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("arg0")))(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("arg1")))(Data_Argonaut_Decode_Combinators.getField(IR.decodeJsonPipeline)(v)("arg2")))(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeArray(decodeJsonTypeInfo))(v)("arg3"));
              };
              return Partial_Unsafe.unsafeCrashWith("decodeJson @ CompileResult");
          });
      });
  });
...
(function(exports) {
  ...
  var meshAttrToStream = function (b) {
      return function (i) {
          return function (a) {
              return Data_Function.apply(Type.Stream.create)((function () {
  ...
  var meshAttrToArray = function (a) {
      if (a instanceof A_Float) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.numStorable))(a.value0));
      };
      if (a instanceof A_V2F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v2Storable(Type.numStorable)))(a.value0));
      };
      if (a instanceof A_V3F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v3Storable(Type.numStorable)))(a.value0));
      };
      if (a instanceof A_V4F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v4Storable(Type.numStorable)))(a.value0));
      };
      if (a instanceof A_M22F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v2Storable(Type.v2Storable(Type.numStorable))))(a.value0));
      };
      if (a instanceof A_M33F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v3Storable(Type.v3Storable(Type.numStorable))))(a.value0));
      };
      if (a instanceof A_M44F) {
          return Data_Function.apply((Type["Array"]).create(Type.ArrFloat.value))(Type.toArray(Type.arrStorable(Type.v4Storable(Type.v4Storable(Type.numStorable))))(a.value0));
      };
      if (a instanceof A_Flat) {
      ...
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeStrMap(decodeJsonMeshAttribute))(v)("attributes"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeJsonMeshPrimitive)(v)("primitive"))(function (v2) {
                  return Data_Function.apply(Control_Applicative.pure(Data_Either.applicativeEither))(new Mesh({
                      attributes: v1, 
                      primitive: v2, 
                      gpuData: Data_Maybe_1.Nothing.value
                  }));
              });
          });
      });
  ...
  var compileMesh = function (v) {
      return Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
          if (v.value0.gpuData instanceof Data_Maybe_1.Just) {
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Mesh(v.value0));
          };
          if (v.value0.gpuData instanceof Data_Maybe_1.Nothing) {
              var mkIndexBuf = function (v1) {
                  return function __do() {
                      ...
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Maybe_1.Just({
                          buffer: v2, 
                          arrIdx: 0, 
                          start: 0, 
              ...
              return function __do() {
                  var v1 = Data_Function.apply(Data.compileBuffer)(Data_Function.apply(Data_Functor.map(Data_Functor.functorArray)(meshAttrToArray))(Data_List.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_StrMap.values(v.value0.attributes))))();
                  var v2 = (function () {
                      if (v.value0.primitive instanceof P_Points) {
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(Type.PointList.value, Data_Maybe_1.Nothing.value));
                      };
                      if (v.value0.primitive instanceof P_TriangleStrip) {
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(Type.TriangleStrip.value, Data_Maybe_1.Nothing.value));
                      };
                      if (v.value0.primitive instanceof P_Triangles) {
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Tuple.Tuple(Type.TriangleList.value, Data_Maybe_1.Nothing.value));
                      };
                  ...
                  var streams = Data_Function.apply(Data_StrMap.fromList)(Data_List.zipWith(function (i) {
                      return function (v3) {
                          return new Data_Tuple.Tuple(v3.value0, meshAttrToStream(v1)(i)(v3.value1));
                      };
                  })(Data_Function.apply(Data_List.range(0))(Data_Function.apply(Data_Maybe_1.fromJust(dictPartial))(Data_Function.apply(Data_Int.fromNumber)(Data_StrMap.size(v.value0.attributes)))))(Data_StrMap.toList(v.value0.attributes)));
                  var gpuData = {
                      primitive: v2.value0, 
                      streams: streams, 
                      indices: v2.value1
                  };
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Mesh.create)((function () {
                      var $60 = {};
                      ...
                      $60.gpuData = new Data_Maybe_1.Just(gpuData);
                      return $60;
                  })()))();
              };
          };
      ...
      return function (slotName) {
          return function (v) {
              return function (objUniNames) {
                  if (v.value0.gpuData instanceof Data_Maybe_1.Nothing) {
                      return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("addMesh: only compiled mesh with GPUData is supported"));
                  };
                  if (v.value0.gpuData instanceof Data_Maybe_1.Just) {
                      var $71 = Data_StrMap.lookup(slotName)(input.schema.slots);
                      if ($71 instanceof Data_Maybe_1.Nothing) {
                          return Data_Function.apply(Control_Monad_Eff_Exception.throwException)(Control_Monad_Eff_Exception.error("addMesh: slot not found"));
                      };
                      if ($71 instanceof Data_Maybe_1.Just) {
                          var filterStream = function (v1) {
                              return Data_StrMap.member(v1.value0)($71.value0.attributes);
                          };
                          return Input.addObject(input)(slotName)(v.value0.gpuData.value0.primitive)(v.value0.gpuData.value0.indices)(Data_Function.apply(Data_StrMap.fromList)(Data_Function.apply(Data_List.filter(filterStream))(Data_StrMap.toList(v.value0.gpuData.value0.streams))))(objUniNames);
                      };
                      throw new Error("Failed pattern match at Mesh line 70, column 13 - line 75, column 136: " + [ $71.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Mesh line 68, column 50 - line 75, column 136: " + [ v.value0.gpuData.constructor.name ]);
              };
          };
      };
  };
...
(function(exports) {
  ...
  var myQuad = new Mesh.Mesh({
      attributes: Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("position", new Mesh.A_V2F([ new LinearBase.V2(-1.0, 1.0), new LinearBase.V2(-1.0, -1.0), new LinearBase.V2(1.0, -1.0), new LinearBase.V2(1.0, -1.0), new LinearBase.V2(1.0, 1.0), new LinearBase.V2(-1.0, 1.0) ])) ])), 
  ...
  var lambdaCube = new Mesh.Mesh({
      attributes: Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("position", new Mesh.A_V3F(lambdaCubeVertices)), new Data_Tuple.Tuple("normal", new Mesh.A_V3F(lambdaCubeNormals)) ])), 
      primitive: Mesh.P_Triangles.value, 
      gpuData: Data_Maybe.Nothing.value
  });
  ...
  var myCube = new Mesh.Mesh({
      attributes: Data_Function.apply(Data_StrMap.fromList)(Data_List.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("position4", new Mesh.A_V4F(g_vertex_buffer_data)), new Data_Tuple.Tuple("vertexUV", new Mesh.A_V2F(g_uv_buffer_data)) ])), 
      primitive: Mesh.P_Triangles.value, 
      gpuData: Data_Maybe.Nothing.value
  });
